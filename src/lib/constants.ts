export const SITE_CONFIG = {
  name: "Hafiz Abdullah",
  title: "Hafiz Abdullah — Developer & AI Solutions Architect",
  description:
    "I build premium modern web applications and AI-powered solutions for businesses. Specializing in Next.js, React, TypeScript, and AI integration.",
  url: "https://eternziv.github.io/abdullah",
  basePath: "/abdullah",
  ogImage: "/images/project-auto-1.png",
  links: {
    github: "https://github.com/EternZiv",
...
My journey started with a curiosity for how things work on the web, and has evolved into a career building sophisticated applications for businesses worldwide. I believe in writing clean, maintainable code and creating interfaces that users love to interact with.`,
  education: [
    { year: "2018 - 2022", degree: "B.S. Computer Science", school: "University of Technology" },
    { year: "2022 - 2023", degree: "M.S. Artificial Intelligence", school: "Tech Institute" },
    { year: "2023 - Present", degree: "Professional Development", school: "Continuous Learning" },
  ],
  skills: [
